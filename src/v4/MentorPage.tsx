    ...
    <section className="mentor-grid-v5">
      <article className="performance-panel">
        ...
        {intel.writing.count ? <>
          ...
          <p>{intel.writing.correctionPending ? "Correção pendente: o texto foi produzido, mas ainda não recebeu nota/diagnóstico." : intel.writing.rewriteNeeded ? intel.writing.pendingRewriteCount + " reescrita(s) pendente(s)." : "Sem correção ou reescrita pendente."} {intel.writing.trend.label}{intel.writing.trend.delta==null?"":" · "+(intel.writing.trend.delta>0?"+":"")+intel.writing.trend.delta.toFixed(1)+" p.p."}.</p>
